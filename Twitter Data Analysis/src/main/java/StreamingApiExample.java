...
public class StreamingApiExample {
    ...
    public void createStreamingConnection(String baseUrl) throws Exception {
    ...
    public void processTwitterStream(InputStream is) throws Exception {
        ...
        try {
            ...
            while (true) {
                try {
                    // trying to store the json tweets into rabbitMQ(according to what I understood)
